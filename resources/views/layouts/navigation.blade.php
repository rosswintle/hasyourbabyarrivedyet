<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-dashboard.application-logo class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dashboard.dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dashboard.dropdown-link :href="route('profile.edit')">
                            {{ __('Profile') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-dashboard.responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-dashboard.responsive-nav-link :href="route('profile.edit')">
                    {{ __('Profile') }}
                </x-dashboard.responsive-nav-link>
